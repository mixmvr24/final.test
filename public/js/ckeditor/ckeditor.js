...
(function() {
    ...
    (function() {
        ...
        function c(a, d, e, h) {
            ...
            if (!h) return 0;
            if ((g = CKEDITOR.filter.instances[h.element.data("cke-filter")]) && !g.check(d)) return c(a, d, e, h.remaining);d = new CKEDITOR.dom.range(h.element);d.selectNodeContents(h.element);d = d.createIterator();d.enlargeBr = a.enlargeBr;d.enforceRealBlocks = a.enforceRealBlocks;d.activeFilter = d.filter = g;a._.nestedEditable = {
                element: h.element,
                container: e,
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a: {
                            ...
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);d.children.length == 1 && (f = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                    ...
                    if (c._length) {
                        for (var h in c)
                            if (h !=
                                ...
                                e = a.getAttribute(h) || "";
                                if (h == "style") a: {
                                    d = c[h];typeof d == "string" && (d = CKEDITOR.tools.parseCssText(d));typeof e == "string" && (e = CKEDITOR.tools.parseCssText(e, true));g = void 0;
                                    for (g in d)
    ...
    */
    ...
    (function() {
        ...
        function v(b) {
            var i = [],
                ...
                d;
            d = b.$.rows;
            for (var p = 0, e, f, c, h = 0, o = d.length; h < o; h++) c = d[h], e = c.cells.length, e > p && (p = e, f = c);
            d = f;
            p = new CKEDITOR.dom.element(b.$.tBodies[0]);
            e = p.getDocumentPosition();
            f = 0;
            for (c = d.cells.length; f < c; f++) {
                var h = new CKEDITOR.dom.element(d.cells[f]),
                    o = d.cells[f + 1] && new CKEDITOR.dom.element(d.cells[f + 1]),
                    a = a + (h.$.colSpan || 1),
                    k, j, l = h.getDocumentPosition().x;
                g ? j = l + n(h, "left") : k = l + h.$.offsetWidth - n(h, "right");
                o ? (l = o.getDocumentPosition().x, g ? k = l + o.$.offsetWidth - n(o, "right") : j = l + n(o, "left")) : (l = b.getDocumentPosition().x, g ? k = l : j = l + b.$.offsetWidth);
                h = Math.max(j - k, 3);
                i.push({
                    table: b,
                    index: a,
        ...
        function z(b) {
            ...
            function a() {
                for (var a = e.rtl, b = a ? l.length : w.length, c = 0; c < b; c++) {
                    var d = w[c],
                        f = l[c],
                        g = e.table;
                    CKEDITOR.tools.setTimeout(function(b, c, d, e, f, h) {
                        b && b.setStyle("width", j(Math.max(c + h, 0)));
                        d && d.setStyle("width", j(Math.max(e - h, 0)));
                        f && g.setStyle("width", j(f + h * (a ? -1 : 1)))
                    }, 0, this, [d, d && t(d), f, f && t(f),
                        (!d || !f) && t(g) + n(g, "left") + n(g, "right"), k
                    ])
                }
            }
            ...
            var e, f, c, h, o, k, w, l, x, y;
            f = b.document;
            c = CKEDITOR.dom.element.createFromHtml('<div data-cke-temp=1 contenteditable=false unselectable=on style="position:absolute;cursor:col-resize;filter:alpha(opacity=0);opacity:0;padding:0;background-color:#004;background-image:none;border:0px none;z-index:10"></div>', f);
            b.on("destroy", function() {
                c.remove()
            });
            s || f.getDocumentElement().append(c);
            this.attachTo = function(a) {
                h ||
                    (s && (f.getBody().append(c), k = 0), e = a, c.setStyles({
                        width: j(a.width),
                        height: j(a.height),
                        left: j(a.x),
                        top: j(a.y)
                    }), s && c.setOpacity(0.25), c.on("mousedown", g, this), f.getBody().setStyle("cursor", "col-resize"), c.show())
            };
            var r = this.move = function(a) {
                if (!e) return 0;
                if (!h && (a < e.x || a > e.x + e.width)) return e = null, h = k = 0, f.removeListener("mouseup", d), c.removeListener("mousedown", g), c.removeListener("mousemove", p), f.getBody().setStyle("cursor", "auto"), s ? c.remove() : c.hide(), 0;
                a -= Math.round(c.$.offsetWidth / 2);
                if (h) {
                    if (a ==
                        x || a == y) return 1;
                    a = Math.max(a, x);
        ...
        function r(b) {
            ...
            i.getAscendant("table", 1).removeCustomData("_cke_table_pillars");
            b.removeListener()
        }
        ...
        CKEDITOR.plugins.add("tableresize", {
            ...
            init: function(b) {
                b.on("contentDom", function() {
                    var i;
                    b.document.getBody().on("mousemove", function(a) {
                        var a = a.data,
                            g = a.getPageOffset().x;
                        if (i && i.move(g)) u(a);
                        else {
                            ...
                            if (a.is("table") || a.getAscendant("tbody", 1)) {
                                d = a.getAscendant("table", 1);
                                if (!(a = d.getCustomData("_cke_table_pillars"))) d.setCustomData("_cke_table_pillars", a = v(d)), d.on("mouseout", r), d.on("mousedown", r);
                                a: {
                                    d = 0;
                                    for (var j = a.length; d < j; d++) {
                                        var e = a[d];
                                        if (g >= e.x &&
                                            g <= e.x + e.width) {
                                            g = e;
    ...
    CKEDITOR.plugins.add("tliyoutube", {
        icons: "tliyoutube",
        init: function(a) {
            a.addCommand("tliyoutubeDialog", new CKEDITOR.dialogCommand("tliyoutubeDialog"));
            a.ui.addButton("tliyoutube", {
        ...
        k.prototype = {
            start: function(a) {
                var d = this,
                    b = this.editor,
                    c = this.doc,
                    e, g, f, h = CKEDITOR.tools.eventsBuffer(50, function() {
                ...
                this.editable.attachListener(this.inline ?
                    this.editable : this.frame, "mouseout",
                    function() {
                        h.reset()
                    })
            },
            ...
            pixelSearch: function() {
                function a(a, c, e, g, f) {
                    for (var h = 0, j; f(e);) {
                        e += g;
                        if (25 == ++h) break;
                        if (j = this.doc.$.elementFromPoint(c, e))
                            if (j == a) h = 0;
            ...
            greedySearch: function() {
                ...
                for (var a = this.editable.getElementsByTag("*"), d = 0, b, c, e; b = a.getItem(d++);)
                    if (!b.equals(this.editable) && (b.hasAttribute("contenteditable") || !b.isReadOnly()) && i(b) && b.isVisible())
        ...
        l.prototype = {
            ...
            sort: function() {
                ...
                return function(f, h) {
                    ...
                    for (c in a)
                        for (e in a[c])
                            if (b = Math.abs(f - a[c][e]), d.length) {
                ...
                if (b = this.getStyle(a.uid, a.type)) {
                    ...
                    if (!c)
                        for (e in this.hidden)
                            if (this.hidden[e].getCustomData("hash") !==
                                this.hash) {
    ...
    (function() {
        ...
        function j(a, b, c, d, e) {
            ...
            CKEDITOR.tools.extend(this, d, {
                ...
                element: c,
                data: CKEDITOR.tools.extend({}, "function" ==
                    typeof d.defaults ? d.defaults() : d.defaults),
                dataReady: !1,
                inited: !1,
                ready: !1,
                edit: j.prototype.edit,
        ...
        function Q(a, b) {
            a.addCommand(b.name, {
                exec: function() {
                    function c() {
                        a.widgets.finalizeCreation(f)
                    }
                    var d = a.widgets.focused;
                    if (d && d.name == b.name) d.edit();
                    else if (b.insert) b.insert();
                    else if (b.template) {
                        var d = "function" == typeof b.defaults ? b.defaults() : b.defaults,
                            d = CKEDITOR.dom.element.createFromHtml(b.template.output(d)),
                            e, g = a.widgets.wrapElement(d, b.name),
                            f = new CKEDITOR.dom.documentFragment(g.getDocument());
                        f.append(g);
        ...
        function s(a, b) {
            a.focused =
                null;
            b.isInited() && (a.fire("widgetBlurred", {
                widget: b
            }), b.setFocused(!1))
        }
            ...
            if ("wysiwyg" == this.editor.mode) {
                ...
                if (b) {
                    ...
                    if (a && a.initOnlyNew) b = this.initOnAll();
                        ...
                        var g = b.find(".cke_widget_wrapper"),
                            b = [];
                        d = 0;
                        for (c = g.count(); d < c; d++) {
                            e = g.getItem(d);
                            var f;
                            if (f = !this.getByElement(e, !0)) {
                                a: {
                                    f = R;
                                    for (var h = e; h = h.getParent();)
                                        if (f(h)) {
                                            f = !0;
                                            break a
                                        }
                            ...
                            f && (e.addClass("cke_widget_new"),
                                b.push(this.initOn(e.getFirst(q))))
                        }
                    }
        ...
        function S(a) {
            ...
            return {
                toBeWrapped: b,
                iterator: function(a) {
                    if ("data-cke-widget-wrapper" in a.attributes) return (a = a.getFirst(u)) && b.push([a]), !1;
                    if ("data-widget" in a.attributes) return b.push([a]), !1;
                    if (c.length)
                        for (var e, g, f, h = 0,
                                i = c.length; h < i; ++h)
                            if (e = c[h], f = {}, g = e[0](a, f)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = JSON.stringify(f), b.push([a, e[1]]), !1
                }
            }
        }
        ...
        function n(a, b, c, d) {
            var e = a.editor;
            e.fire("lockSnapshot");
            c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable = b, b.focusedEditable =
                d, c.addClass("cke_widget_editable_focused"), d.filter && e.setActiveFilter(d.filter), e.setActiveEnterMode(d.enterMode, d.shiftEnterMode)) : (d || b.focusedEditable.removeClass("cke_widget_editable_focused"), b.focusedEditable = null, a.widgetHoldingFocusedEditable = null, e.setActiveFilter(null), e.setActiveEnterMode(null, null));
        ...
        function N(a) {
            ...
            b.on("contentDom", function() {
                ...
                d.attachListener(d.isInline() ? d : b.document, "drop", function(c) {
                    var d = c.data.$.dataTransfer.getData("text"),
                        f, h;
                    if (d) {
                        try {
                            f = JSON.parse(d)
                        ...
                        if ("cke-widget" == f.type && (c.data.preventDefault(), f.editor == b.name && (h = a.instances[f.id]))) {
                            a: if (f = c.data.$, d = b.createRange(), c.data.testRange) d = c.data.testRange;
                                elseif (document.caretRangeFromPoint) c = b.document.$.caretRangeFromPoint(f.clientX,
                                f.clientY),
                            d.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                            d.collapse(!0);
                            else if (f.rangeParent) d.setStart(CKEDITOR.dom.node(f.rangeParent), f.rangeOffset),
                            d.collapse(!0);
                            else if (document.body.createTextRange) c = b.document.getBody().$.createTextRange(),
                            c.moveToPoint(f.clientX, f.clientY),
                            f = "cke-temp-" + (new Date).getTime(),
                            c.pasteHTML('<span id="' + f + '">​</span>'),
                            c = b.document.getById(f),
        ...
        function L(a) {
            ...
            b.on("contentDom", function() {
                ...
                c.attachListener(d, "mousedown", function(c) {
                    ...
                    e = a.getByElement(b);
                    g = 0;
                    e && (e.inline && b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("data-cke-widget-drag-handler") ? g = 1 : l(e.wrapper, b) ? e = null : (c.data.preventDefault(), CKEDITOR.env.ie || e.focus()))
                });
            ...
            b.on("doubleclick", function(c) {
                ...
                if (b && !l(b.wrapper, c.data.element)) return b.fire("doubleclick", {
        ...
        function M(a) {
            a.editor.on("key", function(b) {
                ...
                }) : d && (c = b.data.keyCode, b = d.focusedEditable, c == CKEDITOR.CTRL + 65 ? (c = b.getBogus(), d = d.editor.createRange(), d.selectNodeContents(b), c && d.setEndAt(c, CKEDITOR.POSITION_BEFORE_START), d.select(),
        ...
        function K(a) {
            ...
            b.on("selectionChange", function(c) {
                var d = (c = l(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c),
                    e = a.widgetHoldingFocusedEditable;
                if (e) {
                    if (e !== d || !e.focusedEditable.equals(c)) n(a, e, null), d && c && n(a, d, c)
                } else d && c && n(a, d, c)
            });
            ...
            b.on("toDataFormat", function(b) {
                ...
                b.data.dataValue.forEach(function(b) {
                    ...
                    if ("data-cke-widget-id" in c) {
                        if (c = a.instances[c["data-cke-widget-id"]]) d = b.getFirst(u), g.push({
                            wrapper: b,
                            element: d,
                            widget: c
                        }), "1" != d.attributes["data-cke-widget-keep-attr"] && delete d.attributes["data-widget"]
                    } else if ("data-cke-widget-editable" in c) return delete c.contenteditable, b.setHtml(g[g.length - 1].widget.editables[c["data-cke-widget-editable"]].getData()), !1
                }, CKEDITOR.NODE_ELEMENT)
            }, null, null, 8);
            b.on("toDataFormat", function(a) {
                if (a.data.downcastingSessionId)
                    for (var a =
                            c[a.data.downcastingSessionId], b, g, f; b = a.shift();) g = b.widget, f = b.element, (g = g._.downcastFn && g._.downcastFn.call(g, f)) || (g = f), b.wrapper.replaceWith(g)
            }, null, null, 13);
            b.on("contentDomUnload", function() {
                a.destroyAll(!0)
            })
        ...
        function H(a) {
            ...
            c.on("toHtml", function(b) {
                var c = S(a),
                    e;
                for (b.data.dataValue.forEach(c.iterator, CKEDITOR.NODE_ELEMENT); e = c.toBeWrapped.pop();) {
                    var i = e[0],
                        k = i.parent;
                    k.type == CKEDITOR.NODE_ELEMENT && k.attributes["data-cke-widget-wrapper"] && k.replaceWith(i);
            ...
            c.on("dataReady", function() {
                if (e)
                    for (var b = a, d = c.editable().find(".cke_widget_wrapper"), h, i, k = 0, j = d.count(); k < j; ++k) h = d.getItem(k), i = h.getFirst(q), i.type == CKEDITOR.NODE_ELEMENT && i.data("widget") ? (i.replace(h),
                        b.wrapElement(i)) : h.remove();
                e = 0;
                a.destroyAll(!0);
                a.initOnAll()
            });
        ...
        function C(a) {
            ...
            return {
                ...
                commit: function() {
                    ...
                    for (g && (f = a.focused) && s(a, f); f = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, f), 1), f.isInited() && f.setSelected(!1);
                    g && e && (a.focused = e, a.fire("widgetFocused", {
                        widget: e
                    }), e.setFocused(!0));
                    for (; f = c.pop();) b.push(f), f.setSelected(!0);
        ...
        function B(a, b) {
            ...
            if (!d.getById("cke_copybin")) {
                ...
                g.setStyle("ltr" == c.config.contentsLangDirection ? "left" : "right", "-5000px");
                g.setHtml('<span data-cke-copybin-start="1">​</span>' + a.wrapper.getOuterHtml() + '<span data-cke-copybin-end="1">​</span>');
                c.fire("saveSnapshot");
                c.fire("lockSnapshot");
                f.append(g);
                c.editable().append(f);
                var h = c.on("selectionChange",
                        D, null, null, 0),
                    i = a.repository.on("checkSelection", D, null, null, 0);
                if (e) var k = d.getDocumentElement().$,
                    j = k.scrollTop;
                d = c.createRange();
        ...
        function W(a) {
            if (a.draggable) {
                var b = a.editor;
                b.editable();
                var c = new CKEDITOR.dom.element("img", b.document),
                    d = new CKEDITOR.dom.element("span", b.document);
                d.setAttributes({
        ...
        function X() {
            function a() {
                var a;
                for (k.reset(); a = f.pop();) a.removeListener();
                var b = h,
                    c = this.repository.finder;
                a = this.repository.liner;
                var d = this.editor,
                    e = this.editor.editable();
                CKEDITOR.tools.isEmpty(a.visible) || (b = c.getRange(b[0]), this.focus(), d.fire("saveSnapshot"), d.fire("lockSnapshot", {
                    dontUpdate: 1
                }), d.getSelection().reset(), e.insertElementIntoRange(this.wrapper, b), this.focus(), d.fire("unlockSnapshot"), d.fire("saveSnapshot"));
                e.removeClass("cke_widget_dragging");
                a.hideVisible()
            }
            var b = this.repository.finder,
                c = this.repository.locator,
                d = this.repository.liner,
                e = this.editor,
                g = e.editable(),
                f = [],
                h = [],
                ...
                k = CKEDITOR.tools.eventsBuffer(50, function() {
                    j = c.locate(i);
                    h = c.sort(l, 1);
                    h.length && (d.prepare(i, j), d.placeLine(h[0]), d.cleanup())
                }),
                j, l;
            g.addClass("cke_widget_dragging");
            f.push(g.on("mousemove", function(a) {
                l = a.data.$.clientY;
                k.input()
            }));
            f.push(e.document.once("mouseup", a, this));
            f.push(CKEDITOR.document.once("mouseup", a, this))
        }
        ...
        function P(a, b) {
            ...
            if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) a.wrapper.on("dragstart", function(b) {
                l(a, b.data.getTarget()) || b.data.preventDefault()
            });
            ...
            if (a.draggable) a.on("data", function() {
                ...
                b.setStyle("top", a.element.$.offsetTop - m + "px");
        ...
        o.prototype = {
            ...
            checkSelection: function() {
                ...
                for (a.evaluator = z; b = a.next();) c.select(this.getByElement(b));
                c.commit()
            },
            checkWidgets: function(a) {
                this.fire("checkWidgets",
                    CKEDITOR.tools.copy(a || {}))
            },
            del: function(a) {
                if (this.focused === a) {
                    var b = a.editor,
            ...
            destroyAll: function(a) {
                var b = this.instances,
                    c, d;
                for (d in b) c = b[d], this.destroy(c,
                    a)
            },
            finalizeCreation: function(a) {
                if ((a = a.getFirst()) && z(a)) this.editor.insertElement(a), a = this.getByElement(a), a.ready = !0, a.fire("ready"), a.focus()
            },
            getByElement: function(a, b) {
                if (!a) return null;
                var c, d;
                for (d in this.instances)
                    if (c = this.instances[d].wrapper, c.equals(a) || !b && c.contains(a)) return this.instances[d];
                return null
            },
            initOn: function(a, b, c) {
                ...
                return d ? d.hasClass("cke_widget_new") ?
                    (a = new j(this, this._.nextId++, a, b, c), a.isInited() ? this.instances[a.id] = a : null) : this.getByElement(a) : null
            },
            initOnAll: function(a) {
                for (var a = (a || this.editor.editable()).find(".cke_widget_new"), b = [], c, d = a.count(); d--;)(c = this.initOn(a.getItem(d).getFirst(q))) && b.push(c);
                return b
            },
            wrapElement: function(a, b) {
                ...
                if (a instanceof CKEDITOR.dom.element) {
                    ...
                    e = y(d, a.name);
                    c = new CKEDITOR.htmlParser.element(e ? "span" : "div", w(e));
        ...
        j.prototype = {
            ...
            destroyEditable: function(a, b) {
                ...
                c.removeListener("blur", E);
                this.editor.focusManager.remove(c);
                b ||
                    (c.removeClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), c.removeAttributes(["contenteditable", "data-cke-widget-editable", "data-cke-enter-mode"]));
            ...
            initEditable: function(a, b) {
                ...
                return c && c.is(CKEDITOR.dtd.$editable) ? (c = new p(this.editor, c, {
                    ...
                    c.addClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), b.pathName && c.data("cke-display-name", b.pathName), this.editor.focusManager.add(c), c.on("focus", F, this), CKEDITOR.env.ie && c.on("blur", E, this), c.setData(c.getHtml()), !0) : !1
            },
            isInited: function() {
        ...
        CKEDITOR.event.implementOn(j.prototype);
        p.prototype = CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.dom.element.prototype), {
            setData: function(a) {
        ...
        var V = RegExp('^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?</span>([\\s\\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?</span>(?:</(?:div|span)>)?(?:</(?:div|span)>)?$'),
            G = "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D",
            ba = {
                37: 1,
                38: 1,
                39: 1,
    ...
    (function() {
        CKEDITOR.plugins.add("oembed", {
            ...
            lang: "de en fr nl pl pt-br ru tr".split(" "),
            version: 1.14,
            init: function(c) {
                function k(a, d, b, e, h, g, f) {
                    jQuery.noConflict();
                    jQuery("body").oembed(a, {
                        onEmbed: function(a) {
                            var d = !1;
                            "string" === typeof a.code ? (f.element.$.firstChild && f.element.$.removeChild(f.element.$.firstChild), f.element.appendHtml(a.code), d = !0) : "string" === typeof a.code[0].outerHTML ? (f.element.$.firstChild && f.element.$.removeChild(f.element.$.firstChild),
                                f.element.appendHtml(a.code[0].outerHTML), d = !0) : alert(c.lang.oembed.noEmbedCode);
                            d && b && CKEDITOR.dialog.getCurrent().hide()
                        },
                        onError: function(a) {
                            0 < a.indexOf("vimeo.com") ? alert(c.lang.oembed.noVimeo) : alert(c.lang.oembed.Error)
                        },
                        maxHeight: h,
                        maxWidth: e,
                        useResponsiveResize: g,
                        embedMethod: "editor"
                    })
                }(function() {
                    "undefined" === typeof jQuery ? CKEDITOR.scriptLoader.load("http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js", function() {
                        "undefined" === typeof jQuery.fn.oembed && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("oembed") +
                ...
                CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
                    oEmbed: function(a, d, b, e) {
                        function h() {
                            if (null == d || "undefined" == d) d = null;
                            if (null == b || "undefined" == b) b = null;
                            if (null == e || "undefined" == e) e = !1;
                            k(a, c, !1, d, b, e)
                        }
                        if (1 > a.length || 0 > a.indexOf("http")) return alert(c.lang.oembed.invalidUrl), !1;
                        "undefined" === typeof jQuery.fn.oembed ?
                ...
                c.widgets.add("oembed", {
                    mask: !0,
                    dialog: "oembed",
                    allowedContent: "div(!" + (null != c.config.oembed_WrapperClass ? c.config.oembed_WrapperClass : "embeddedContent") + ");div iframe[*]",
                    template: '<div class="' + (null != c.config.oembed_WrapperClass ? c.config.oembed_WrapperClass : "embeddedContent") + '"></div>',
                    upcast: function(a) {
                        return "div" == a.name && a.hasClass(null != c.config.oembed_WrapperClass ?
                            c.config.oembed_WrapperClass : "embeddedContent")
                    }
                });
                c.ui.addButton("oembed", {
                    label: c.lang.oembed.button,
                    command: "oembed",
                    toolbar: "insert,10",
                ...
                var j = function() {
                    var a = this.getDialog(),
                        d = this.getValue(),
                        b = a.getContentElement("general", "maxSizeBox").getElement(),
                        a = a.getContentElement("general", "sizeBox").getElement();
                    "noresize" == d ? (b.hide(), a.hide()) : "custom" == d ? (b.hide(), a.show()) : (b.show(), a.hide())
                };
                ...
                CKEDITOR.dialog.add("oembed", function(a) {
                    return {
                        ...
                        minHeight: 155,
                        onShow: function() {
                            var a = this.getContentElement("general", "resizeType").getValue(),
                                b = this.getContentElement("general", "maxSizeBox").getElement(),
                                e = this.getContentElement("general", "sizeBox").getElement();
                            "noresize" == a ? (b.hide(), e.hide()) : "custom" == a ? (b.hide(), e.show()) : (b.show(), e.hide())
                        },
                        onOk: function() {},
                        contents: [{
                            ...
                            elements: [{
                                ...
                                setup: function(a) {
                                    a.data.oembed && this.setValue(a.data.oembed)
                                },
                                commit: function(d) {
                                    var b = CKEDITOR.dialog.getCurrent(),
                                        e = b.getValueOf("general", "embedCode").replace(/\s/g, ""),
                                        c = b.getContentElement("general", "resizeType").getValue(),
                                        g = null,
                                        f = null,
                                        i = !1,
                                        j = b.getParentEditor(),
                                        l = b.getContentElement("general", "autoCloseDialog").getValue();
                                    if (1 > e.length || 0 > e.indexOf("http")) return alert(a.lang.oembed.invalidUrl), !1;
                                    "noresize" == c ? i = !1 : "responsive" == c ? (g = b.getContentElement("general", "maxWidth").getInputElement().getValue(), f = b.getContentElement("general", "maxHeight").getInputElement().getValue(), i = !0) : "custom" == c && (g = b.getContentElement("general", "width").getInputElement().getValue(), f = b.getContentElement("general", "height").getInputElement().getValue(),
                                        i = !1);
                                    k(e, j, l, g, f, i, d);
                                    d.setData("oembed", e)
                                }
                                ...
                                children: [{
                                    id: "resizeType",
                                    type: "select",
                                    label: a.lang.oembed.resizeType,
                                    "default": "noresize",
                                    items: [
                                        [a.lang.oembed.noresize, "noresize"],
                                        [a.lang.oembed.responsive, "responsive"],
                                        [a.lang.oembed.custom, "custom"]
                                    ],
                                    onChange: j
                                }, {
                                    type: "hbox",
                                    ...
                                    children: [{
                                        ...
                                        width: "100px",
                                        id: "maxWidth",
                                        "default": null != a.config.oembed_maxWidth ?
                                            a.config.oembed_maxWidth : "560",
                                        label: a.lang.oembed.maxWidth,
                                        title: a.lang.oembed.maxWidthTitle
                                    }, {
                                        type: "text",
                                        id: "maxHeight",
                                        width: "120px",
                                        "default": null != a.config.oembed_maxHeight ? a.config.oembed_maxHeight : "315",
                                        label: a.lang.oembed.maxHeight,
                                        title: a.lang.oembed.maxHeightTitle
                                    }]
                                }, {
                                    type: "hbox",
                                    id: "sizeBox",
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,tableresize,sourcedialog,showborders,tliyoutube,lineutils,widget,oembed,language,imagebrowser';
    ...
    (function() {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,spellchecker,1032,,sourcedialog-rtl,1056,,sourcedialog,1080,,tliyoutube,2208,auto,oembed,1128,,language,1152,', 'icons_hidpi.png');
        else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,spellchecker,1032,auto,sourcedialog-rtl,1056,auto,sourcedialog,1080,auto,tliyoutube,1104,auto,oembed,1128,auto,language,1152,auto', 'icons.png');
    })();
