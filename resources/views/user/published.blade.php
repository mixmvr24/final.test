    ...
    <div id="header" class="header b-f">
        <div class="header-nav-user">
            <div class="container text-center">
                ...
                <div></div><link href="{{asset("/css/style-userpanel.css")}}">
        ...
        <div class="container">
            <div class="main-cont row">
                <div class="col-sm-12 col-content b-f bl-pad br3">
                    ...
                    <div class="table-action bl-tb transf">
                        <div class="bl-inl al-top cl-check2 pos-rel">
                            <div class="bl-inl al-top cl-check"><label for="checkAll" class="cl-check-label"><input
                                        type="checkbox" id="checkAll"/></label></div>
                        </div>
                        Выбрать всё → <a id="panel_delete" href="#" class="btn btn-default pos-rel">Удалить выбранное</a>
                        <div class="table-search bl-inl pull-right"><input class="form-control" type="text" id="ads-filter"
                                                                           placeholder="найти на странице"></div>
                    </div>
                    <div class="text-center">
                        <div class="count-l s18 bl-inl">Нет объявлений</div>
                    </div>
