    ...
    <div id="main"><div class="container">
            <div class="main-cont row">
                <div class="col-sm-9 col-content b-f bl-pad br3">
                    <img class="imgcat pull-left hidden-xs" src="{{asset('/images/cat10.png')}}" alt="Бытовая техника">
                    <h1>Бытовая техника</h1>
                    <ul class="row tree1">
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/audio/" class="pos-rel b-f">
                                    Аудио, Видео</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/games/" class="pos-rel b-f">
                                    Игры, игровые приставки</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/gps/" class="pos-rel b-f">
                                    GPS-навигаторы</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/pilesosi/" class="pos-rel b-f">
                                    Пылесосы</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/stiralnie/" class="pos-rel b-f">
                                    Стиральные машины</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/kuhonnaya/" class="pos-rel b-f">
                                    Кухонная техника</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/glagka/" class="pos-rel b-f">
                                    Швейное оборудование</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/klimat/" class="pos-rel b-f">
                                    Климатическая техника</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/remont/" class="pos-rel b-f">
                                    Ремонт и сервис</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Bytovaya-tehnika/other/" class="pos-rel b-f">
                    ...
                    <div id="search_form_cat" class="block_search pos-rel">
                        ...
                        <div id="colsearch" class="collapse in"><form id="block_search" name="block_search" method="GET" action="/search/">
                                <input type="hidden" name="add_cat" class="add_cat" value="9"><input type="hidden" name="add_region" class="add_region" value=""><input type="hidden" name="map" class="add_map" value="">
                    ...
                    <div class="promo-subscribe bl-tb"><div class="promo-subscribe-text pull-left">Получайте новые объявления<br>из категории Бытовая техника</div>
