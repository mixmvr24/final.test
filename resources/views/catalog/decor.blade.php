    ...
    <div id="main"><div class="container">
            <div class="main-cont row">
                <div class="col-sm-9 col-content b-f bl-pad br3">
                    <img class="imgcat pull-left hidden-xs" src="{{asset('/images/cat5.png')}}" alt="Мебель, интерьер">
                    <h1>Мебель, интерьер</h1>
                    <ul class="row tree1">
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Mebel-interer/interer/" class="pos-rel b-f">
                                    Мебель и интерьер</a><span class="count-tree1 b-f pos-abs c-a s13">1</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Mebel-interer/obihod/" class="pos-rel b-f">
                                    Предметы обихода</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Mebel-interer/remont/" class="pos-rel b-f">
                                    Ремонт и сервис</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Mebel-interer/other/" class="pos-rel b-f">
                    ...
                    <div id="search_form_cat" class="block_search pos-rel">
                        ...
                        <div id="colsearch" class="collapse in"><form id="block_search" name="block_search" method="GET" action="/search/">
                                <input type="hidden" name="add_cat" class="add_cat" value="13"><input type="hidden" name="add_region" class="add_region" value=""><input type="hidden" name="map" class="add_map" value="">
                                            ...
                                            <div class="dropdown yamm-fw">
                                                ...
                                                <div class="dropdown-menu">
                                                    <div class="slider-inputs">
                                                        <div class="slider-cont" data-id="f_27" data-min="228000" data-max="252000">
                    ...
                    <div class="filter-panel bl-tb br6 fpc">
                        <div class="filter-mes btn-group">
                            <a class="btn btn-default" role="button" href="?filter[shop]=all" rel="nofollow">Все <span class="c-7 s13">(1)</span></a>
