    ...
    <div id="main"><div class="container">
            <div class="main-cont row">
                <div class="col-sm-9 col-content b-f bl-pad br3">
                    <img class="imgcat pull-left hidden-xs" src="{{asset('/images/cat12.png')}}" alt="Услуги">
                    <h1>Услуги</h1>
                    <ul class="row tree1">
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/webdesign/" class="pos-rel b-f">
                                    Web дизайн</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/accounting/" class="pos-rel b-f">
                                    Бухгалтерские</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/medical/" class="pos-rel b-f">
                                    Медицинские</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/nursemaids/" class="pos-rel b-f">
                                    Няни, Сиделки</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/translation/" class="pos-rel b-f">
                                    Перевод текстов</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/printing/" class="pos-rel b-f">
                                    Полиграфия</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/advancement_site/" class="pos-rel b-f">
                                    Продвижение сайта</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/advertisment/" class="pos-rel b-f">
                                    Реклама</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/travel/" class="pos-rel b-f">
                                    Туризм, Путешествия, Отдых</a><span class="count-tree1 b-f pos-abs c-a s13">0</span></div></li>
                        <li class="col-xs-6 col-sm-6 col-md-4 colp"><div class="tree-l sp-now pos-rel"><a href="https://coredo.elite-board.org/Uslugi/other/" class="pos-rel b-f">
                    ...
                    <div id="search_form_cat" class="block_search pos-rel">
                        ...
                        <div id="colsearch" class="collapse in"><form id="block_search" name="block_search" method="GET" action="/search/">
                                <input type="hidden" name="add_cat" class="add_cat" value="11"><input type="hidden" name="add_region" class="add_region" value=""><input type="hidden" name="map" class="add_map" value="">
                    ...
                    <div class="promo-subscribe bl-tb"><div class="promo-subscribe-text pull-left">Получайте новые объявления<br>из категории Услуги</div>
